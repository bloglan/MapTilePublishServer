(function () {
    ...
    L.GridLayer.TileGrid = L.GridLayer.extend({
        createTile: function (coords) {
            ...
            tile.innerHTML =
                '<span style="display: inline-block; line-height: 256px; vertical-align: middle; font-size: 12px; font-weight: bold; text-shadow: -1px 0 white, 0 1px white, 1px 0 white, 0 -1px white;">' +
                coords.x.toString() + ', ' +
