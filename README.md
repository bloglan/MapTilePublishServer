# Map Tile Publish Server

Map Tile Publish Server是一个将地图瓦片按xyz、tms、wmts、wms等协议规范发布为服务的服务器系统。

Map Tile Publish Server不能只具有发布瓦片的功能，不具备数据加工和切片能力。

本系统参照了[apdevelop/tile-map-service-net5](https://github.com/apdevelop/tile-map-service)，以下是该代码作者的README参考：
